...
ipcMain.on('python-send-data', (event, keyCode) => {
    console.log(`Received keyCode: ${keyCode}`);

    // Run the Python script with the keyCode as an argument
    const pythonProcess = spawn('python3', [path.join(__dirname, 'wifi_send_data.py'), keyCode.toString()]);
